      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Link
            ...
            className="group rounded-xl bg-white p-8 shadow-md transition-all hover:shadow-xl"
          >
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-teal-100 text-teal-600 group-hover:bg-teal-600 group-hover:text-white">
              <svg
                className="h-6 w-6"
                fill="none"
                stroke="currentColor"
            ...
            <p className="text-gray-600">
              View usage statistics, popular items, and wardrobe insights.
            </p>
          </Link>
        </div>
